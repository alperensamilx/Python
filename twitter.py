...
TWITTER_EMAIL = YOUR TWITTER USERNAME
...
class InternetSpeedTwitterBot:
    ...
    def tweet_at_provider(self):
        ...
        time.sleep(2)
        email = self.driver.find_element_by_xpath('//*[hg@id="react-root"]/div/div/div[2]/main/div/div/div[1]/form/div/div[1]/label/div/div[2]/div/input')
